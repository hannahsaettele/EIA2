namespace L11_2_GoldenerHerbstFinale {
    ...
    */
    ...
    function createExtras (_event: MouseEvent): void {

        if (_event.y >  crc2.canvas.height * golden) {
    ...
    function createRaindrop(): void {

        let oneRaindrop: Raindrop = new Raindrop;
